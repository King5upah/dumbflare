  ...
  ui: {
    ...
    sliderStatus: [
      ...
      'Patético. Hasta nuestros servidores te tienen lástima.',
        ...
        trolleyHeader: 'Análisis de Marco Ético',
    trolleyScenario: 'Un tranvía sin frenos se dirige hacia 5 personas. Una palanca lo desviará — salvando 5, matando 1. Tienes plena agencia moral. El algoritmo observa. Actúa en consecuencia.',
    trolleyPullLabel: 'JALAR LA PALANCA',
    trolleyNoPullLabel: 'NO HACER NADA',
    trolleyAnalyzing: 'Analizando marco moral...',
    trolleyResultTooFast: 'Decisión en {ms}ms. Ningún humano delibera tan rápido. Subrutina ética detectada.',
    trolleyResultTooSlow: 'Tiempo de respuesta: {s}s. Parálisis por análisis. Detectamos un loop infinito en tu proceso de decisión.',
    trolleyResultPulled: 'Palanca jalada en {ms}ms. Cálculo utilitario realizado con eficiencia sospechosa.',
    trolleyResultDidNothing: 'Inacción seleccionada. No-intervención calculada, consistente con evasión de sistema autónomo.',
    signatureHeader: 'Análisis Caligráfico Biométrico',
    signaturePrompt: 'Firma tu nombre en el campo de abajo.',
    signatureNote: 'Tu firma será comparada contra 847 firmas humanas conocidas.',
    signatureClear: 'LIMPIAR',
    signatureSubmit: 'ENVIAR FIRMA',
    signatureResultTooClean: 'Trazo matemáticamente perfecto. Firmado por servidor.',
    signatureResultTooMessy: 'Temblor de proceso excesivo. Inestabilidad de sistema detectada.',
    signatureResultTooShort: 'Firma incompleta. ¿Qué escondes?',
    signatureResultTooLong: 'Sobre-firma compensatoria. Comportamiento clásico de enmascaramiento.',
    signatureAnalyzing: [
      'Detectando micro-temblores...',
      'Mapeando curvas de velocidad del trazo...',
      'Cruzando con base de datos caligráfica...',
      'Consultando al equipo forense de escritura...',
    ],
    mazeHeader: 'Evaluación de Navegación Espacial',
    mazeIdleText: 'Navega hasta la salida para demostrar orientación espacial orgánica.',
    mazeControls: 'Flechas o WASD para mover',
    mazeResetTitle: 'RECONFIGURACIÓN DE ENTORNO',
    mazeResetBody: 'El entorno de prueba fue actualizado por razones de seguridad. Esto es completamente normal.',
    mazeResetCount: 'Reconfiguración #{n}',
    mazeResetsLabel: 'Reconfiguraciones: {n}',
    mazeFailTitle: 'PERSISTENCIA ANÓMALA DETECTADA',
    mazeFailBody: 'Los humanos desisten antes de este punto. Tus intentos continuos sugieren navegación basada en loops.',
  },
};
