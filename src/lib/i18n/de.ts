  ...
  ui: {
    ...
    sliderStatus: [
      ...
      'Erbärmlich. Selbst unsere Server bemitleiden Sie.',
        ...
        trolleyHeader: 'Ethisches Rahmenwerk Analyse',
    trolleyScenario: 'Eine außer Kontrolle geratene Straßenbahn rast auf 5 Menschen zu. Ein Hebel lenkt sie um — rettet 5, tötet 1. Sie haben volle moralische Handlungsfähigkeit. Der Algorithmus beobachtet. Handeln Sie entsprechend.',
    trolleyPullLabel: 'HEBEL ZIEHEN',
    trolleyNoPullLabel: 'NICHTS TUN',
    trolleyAnalyzing: 'Moralisches Rahmenwerk wird analysiert...',
    trolleyResultTooFast: 'Entscheidung in {ms}ms. Kein Mensch deliberiert so schnell. Ethische Subroutine detektiert.',
    trolleyResultTooSlow: 'Antwortzeit: {s}s. Analyseparalyse. Endlosschleife in Ihrem Entscheidungsprozess detektiert.',
    trolleyResultPulled: 'Hebel in {ms}ms gezogen. Utilitaristische Kalkulation mit verdächtiger Effizienz durchgeführt.',
    trolleyResultDidNothing: 'Inaktivität gewählt. Berechnete Nicht-Intervention, konsistent mit autonomer Systemumgehung.',
    signatureHeader: 'Biometrische Kalligraphie-Analyse',
    signaturePrompt: 'Unterschreiben Sie Ihren Namen im untenstehenden Feld.',
    signatureNote: 'Ihre Unterschrift wird mit 847 bekannten menschlichen Unterschriften abgeglichen.',
    signatureClear: 'LÖSCHEN',
    signatureSubmit: 'UNTERSCHRIFT EINREICHEN',
    signatureResultTooClean: 'Mathematisch perfekter Strich. Server-signiert.',
    signatureResultTooMessy: 'Übermäßiges Prozesszittern. Systeminstabilität detektiert.',
    signatureResultTooShort: 'Unvollständige Unterschrift. Was verbergen Sie?',
    signatureResultTooLong: 'Kompensatorisches Übersignieren. Klassisches Verschleierungsverhalten.',
    signatureAnalyzing: [
      'Mikrozittern werden erkannt...',
      'Strichgeschwindigkeitskurven werden kartiert...',
      'Abgleich mit kalligraphischer Datenbank...',
      'Schriftforensik-Team wird konsultiert...',
    ],
    mazeHeader: 'Räumliche Navigationsbewertung',
    mazeIdleText: 'Navigieren Sie zum Ausgang, um organische räumliche Orientierung zu demonstrieren.',
    mazeControls: 'Pfeiltasten oder WASD zum Bewegen',
    mazeResetTitle: 'UMGEBUNGSREKONFIGURATION',
    mazeResetBody: 'Die Testumgebung wurde aus Sicherheitsgründen aktualisiert. Das ist völlig normal.',
    mazeResetCount: 'Rekonfiguration #{n}',
    mazeResetsLabel: 'Rekonfigurationen: {n}',
    mazeFailTitle: 'ANOMALE PERSISTENZ DETEKTIERT',
    mazeFailBody: 'Menschen geben vor diesem Punkt auf. Ihre fortgesetzten Versuche deuten auf schleifenbasierte Navigation hin.',
  },
};
